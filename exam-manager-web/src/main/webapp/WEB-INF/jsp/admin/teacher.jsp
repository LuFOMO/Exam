...
<div class="container" style="padding-top: 70px;">
	...
	<!-- 修改教师信息 -->
	<div id="teacherEdit" class="easyui-dialog"
		...
		<form id="editMsg" method="post">
			<div class="control-group">
				<div class="controls">
					<label class="control-label text-right">用户名：</label> <input
						type="text" name="name" />
				</div>
			</div>
			<br>
			<div class="control-group">
				<div class="controls">
					<label class="control-label text-right">密码：</label> <input
			...
			<div class="control-group">
				<div class="controls">
					<label class="control-label text-right">全名：</label> <input
			...
			<div class="control-group">
				<div class="controls">
					<input type="button" class="btn btn-md btn-primary" value="修改"
						onclick="teacherEdit()" />
				</div>
			</div>
		</form>

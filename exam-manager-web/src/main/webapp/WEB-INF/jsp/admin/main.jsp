	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<img alt="" src="<%=basePath%>/img/exam/teach.jpg" >
				</div>
				<div class="caption">
					<h3>教师管理</h3>
					<ul>
						...
						<p class="masthead-button-links">
							<a class="btn btn-lg btn-primary btn-shadow" href="/admin/teacher">GO</a>
						</p>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6" >
				<div class="thumbnail">
					<img alt="" src="<%=basePath%>/img/exam/clean.jpg">
				</div>
				<div class="caption">
					<h3>考试清理</h3>
					<ul>
						...
						<p class="masthead-button-links">
							<a class="btn btn-lg btn-primary btn-shadow" href="/admin/exam">GO</a>
						</p>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6" >
				<div class="thumbnail">
					<img alt="" src="<%=basePath%>/img/exam/config.jpg">
				</div>
				<div class="caption">
					<h3>系统配置</h3>
					<ul>
						...
						<p class="masthead-button-links">
							<br /> <a class="btn btn-lg btn-primary btn-shadow" href="/admin/system/config">GO</a>
						</p>
					</ul>
				</div>
			</div>
